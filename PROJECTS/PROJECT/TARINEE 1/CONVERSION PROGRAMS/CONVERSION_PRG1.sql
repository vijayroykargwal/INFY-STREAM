...
---------------------------------PROCEDURE START------------------
CREATE OR REPLACE PROCEDURE SP_SUPPLIERS_INT_04(ERRBUF OUT VARCHAR2, RETCODE OUT VARCHAR2) 
IS
...
BEGIN
  IF col_suppliers_info(v_index).ERROR_MESSAGE IS NULL THEN
      INSERT INTO AP_SUPPLIERS_INT(VENDOR_INTERFACE_ID,VENDOR_NAME,CREATED_BY,CREATION_DATE,LAST_UPDATE_DATE,
      LAST_UPDATE_LOGIN,LAST_UPDATED_BY,SHIP_TO_LOCATION_ID,BILL_TO_LOCATION_ID,INVOICE_CURRENCY_CODE,PAYMENT_CURRENCY_CODE)
      VALUES(SEQ_VENDOR_INT_ID_G04.NEXTVAL,col_suppliers_info(v_index).VENDOR_NAME,
      V_CREATED_BY,
